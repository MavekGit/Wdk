...
static const yytype_uint8 yyrline[] =
{
      ...
      91,    94,    95,    96,    99,   100,   101,   104,   105,   106,
     108,   109,   110
};
#endif
...
{
  "$end", "error", "$undefined", "MAX", "MEAN", "MIN", "MEDIAN", "LICZBA",
  "ZNAK", "'+'", "'-'", "'*'", "'/'", "NEG", "'^'", "'\\n'", "'='", "'('",
  "')'", "','", "$accept", "program", "wyrazenie", "param_max",
  "param_min", "param_mean", "param_median", YY_NULLPTR
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
      ...
      45,    42,    47,   264,    94,    10,    61,    40,    41,    44
};
# endif
...
{
       0,   -13,    16,   -14,   -14,    -4,     1,     8,    18,   -14,
      22,    24,    24,    52,    48,    65,    71,    72,    24,    45,
      42,    24,    24,    24,    24,    24,   -14,   -14,    26,   -14,
      39,   -14,    56,   -14,    58,    59,   -14,    28,    28,    45,
      45,    45,   -14,    73,   -14,    74,   -14,    75,   -14,    76,
     -14,   -14,   -14,   -14
};
...
{
       0,     0,    20,     3,     1,     0,     0,     0,     0,     5,
       6,    20,    20,     0,    23,    29,    26,    32,    20,    14,
       0,    20,    20,    20,    20,    20,     2,    21,     0,    27,
       0,    24,     0,    30,     0,     8,    11,     9,    10,    12,
      19,    13,    15,     0,    17,     0,    16,     0,    18,     0,
      22,    28,    25,    31
};
...
{
      -4,     1,     3,    -4,    -4,    -4,    -4,    -4,    -4,    -4,
      -4,    -4,    -4,    14,    -4,    -4,     4,    -4,    15,     5,
       6,     7,     8,     9,    10,    16,    11,     5,     6,     7,
       8,     9,    10,    12,    11,    17,    19,    20,    18,    23,
      24,    12,    25,    35,    42,    43,    37,    38,    39,    40,
      41,    21,    22,    23,    24,    27,    25,    44,    45,    25,
      36,    21,    22,    23,    24,     0,    25,    26,    21,    22,
      23,    24,    29,    25,    46,    47,    48,    49,    31,    33,
      50,    51,    52,    53
};
...
static const yytype_int8 yycheck[] =
{
      ...
      10,    11,    12,    17,    14,    15,     0,    17,    17,     3,
       4,     5,     6,     7,     8,    17,    10,     3,     4,     5,
       6,     7,     8,    17,    10,    17,    11,    12,    16,    11,
      12,    17,    14,    18,    18,    19,    21,    22,    23,    24,
      25,     9,    10,    11,    12,     7,    14,    18,    19,    14,
      18,     9,    10,    11,    12,    -1,    14,    15,     9,    10,
      11,    12,     7,    14,    18,    19,    18,    19,     7,     7,
       7,     7,     7,     7
};
...
{
       0,     1,    21,    15,     0,     3,     4,     5,     6,     7,
       8,    10,    17,    22,    17,    17,    17,    17,    16,    22,
      22,     9,    10,    11,    12,    14,    15,     7,    23,     7,
      25,     7,    24,     7,    26,    22,    18,    22,    22,    22,
      22,    22,    18,    19,    18,    19,    18,    19,    18,    19,
       7,     7,     7,     7
};
...
#line 62 "parser.y" /* yacc.c:1646  */
    { (yyval.dtype) = (yyvsp[-1].dtype)/licznik; ; licznik=0; }
#line 1460 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 18:
#line 63 "parser.y" /* yacc.c:1646  */
    { for(int i = 0; i  < pt_buffer; i++)
                                            ...
                                            if(pt_buffer%2==0)
                                            { 
                                                (yyval.dtype) = buffer[pt_buffer/2]-1;
                                            }
                                            else
                                            {
                                                (yyval.dtype) = (buffer[int(pt_buffer/2)]+buffer[int(pt_buffer/2)+1])/2.0;
                                                pt_buffer = 0;
                                            }  }
...
#line 95 "parser.y" /* yacc.c:1646  */
    { (yyval.dtype) = (yyvsp[-2].dtype) > (yyvsp[0].dtype) ? (yyvsp[-2].dtype) : (yyvsp[0].dtype); }
...
#line 104 "parser.y" /* yacc.c:1646  */
    { (yyval.dtype) = (yyvsp[0].dtype); licznik++; }
#line 1526 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 28:
#line 105 "parser.y" /* yacc.c:1646  */
    { (yyval.dtype) = (yyvsp[-2].dtype) + (yyvsp[0].dtype); licznik++; }
#line 1532 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 30:
#line 108 "parser.y" /* yacc.c:1646  */
    { buffer[0] = (yyvsp[0].dtype); pt_buffer = 0; }
#line 1538 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 31:
#line 109 "parser.y" /* yacc.c:1646  */
    { buffer[pt_buffer++] = (yyvsp[0].dtype); }
